...
prompt: |
  Across the workspace files lib.py and main.py, rename the function
...
gates:
  ...
  - name: new_name_present
    ...
    watch_paths: [lib.py]
timeout: 600
tags: [coding, refactor, multi-file]
flaky: false
...
files:
  lib.py: |
    def fetch_data(source):
        ...
        return {"local": 40, "remote": 2}[source]


    def combine():
        return fetch_data("local") + fetch_data("remote")
  main.py: |
    from lib import combine, fetch_data
